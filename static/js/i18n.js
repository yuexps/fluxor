window.i18n = (function() {
    ...
    const translations = {
        zh: {
            ...
            'config.proxy_url_placeholder': 'http(s)://host:port',
            'config.enable_token': '启用 GitHub Token',
            'config.github_token': 'GitHub Token',
            'config.token_placeholder': '输入个人访问令牌',
            'config.token_link': '获取令牌',
            'config.modify_metacubexd': '修改 MetaCubeXD 后端地址',
            'config.metacubexd_backend_url': 'MetaCubeXD 后端地址',
            'config.metacubexd_url_placeholder': 'http(s)://host:port',
            ...
            'config.dns_hijack': 'DNS 劫持地址',
            'config.dns_hijack_placeholder': '例如：any:53',
            'config.mtu': 'MTU 值',
            'config.mtu_default': '默认 1500',
            ...
            'config.dns_result_default': '查询结果将显示在这里',
            ...
            'subscription.rule_group_lite': '基础 (Lite)',
            'subscription.rule_group_base': '标准 (Base)',
            'subscription.rule_group_full': '完整 (Full)',
            'subscription.prefix_switch': '启用节点前缀',
            'subscription.subscription_list': '订阅列表',
            'subscription.add_subscription': '添加订阅',
            'subscription.save_settings': '保存设置',
        ...
        en: {
            ...
            // ===== Config =====
            'config.proxy_settings': 'Proxy Settings',
            'config.enable_proxy': 'Enable Proxy',
            'config.proxy_url': 'Proxy URL',
            'config.proxy_url_placeholder': 'http(s)://host:port',
            'config.enable_token': 'Enable GitHub Token',
            'config.github_token': 'GitHub Token',
            'config.token_placeholder': 'Enter personal access token',
            'config.token_link': 'Get Token',
            'config.modify_metacubexd': 'Modify MetaCubeXD Backend URL',
            'config.metacubexd_backend_url': 'MetaCubeXD Backend URL',
            'config.metacubexd_url_placeholder': 'http(s)://host:port',
            ...
            'config.dns_hijack_placeholder': 'e.g., any:53',
            'config.mtu': 'MTU',
            'config.mtu_default': 'Default 1500',
